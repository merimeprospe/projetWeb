  ...
  <div class="container">
    ...
    <div class="container header">
      <?php if ($utilisateur['photo_couverture']) {
        ...
        echo '<img src="assets/images/3il.jpeg" alt="Photo de couverture par défaut" class="profile-picture-couverture">';
      } ?>
    </div>
                        ...
                        <div class="card-body">
                          <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                              ...
                              <small><?php echo date('d/m/Y', strtotime($publication["created_at"])); ?></small>
                            </div>
                          </div>
  ...
  <div id="profilePopup" class="popup">
    <div class="popup-content">
      ...
      <form action="routeur.php?action=modifierProfil&id=<?= $utilisateur['id_user'] ?>" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" id="loisirs" name="loisirs" value="<?= $utilisateur['loisirs'] ?? '' ?>">
