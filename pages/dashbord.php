...
<body>
    <div class="container-fluid">
        <div class="row">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link text-white" href="routeur.php?action=dashboard">
                                <i class="uil uil-speedometer"></i> Tableau de Bord
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link text-white" href="routeur.php?action=listUsers">
                                <i class="uil uil-people"></i> Gestion des Utilisateurs
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4" style="margin-top: 8vh;">
                <!-- Tableau de bord Section -->
                <h2 class="mb-4">Tableau de Bord</h2>

                <section id="dashboard" class="mb-5">
                    <div class="row" style="margin: auto;">
                        <div class="col-md-4" style="margin: 4vh 10vh;">
